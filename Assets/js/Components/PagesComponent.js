                    ...
                    loaded: function($container, exists) {
                        if(!exists) {
                            CentauriAjax(
                                ...
                                {
                                    success: function(data) {
                                        var newCEButton = Centauri.Components.PagesComponent.newCEButton;
                                        data = JSON.parse(data);
...
Centauri.Components.PagesComponent.newCEButton = "<button class='btn btn-default m-0 py-2 px-2 waves-effect waves-light' data-action='newContentElement'><i class='fas fa-plus'></i> Content</button>";
