Centauri.Component.ATagComponent = () => {
    ...
    $("a").on("click", this, function(e) {
        ...
        if(Centauri.Utility.ContentUtility.getCachedContentByIdentifier(href) != "") {
            Centauri.Utility.ContentUtility.loadCachedContent(href);
        } else {
            Centauri.Component.ATagComponent.ajaxRequest(href, (html) => {
                let seoUrl = Centauri.Utility.SeoUrlUtility($this.text());

                Centauri.Utility.ContentUtility.addCachedContent(href, html);
