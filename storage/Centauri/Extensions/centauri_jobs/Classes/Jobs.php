...
use Centauri\Extension\Jobs\Models\JobsModel;

class Jobs
{
    private $modelNamespace = "\Centauri\Extension\Jobs\Models\JobsModel";
    ...
    public function __construct()
    {
        ...
        $GLOBALS["Centauri"]["Plugins"]["centauri_jobs_pi1"] = [
            "Jobs Plugin" => "\Centauri\Extension\Plugins\JobsPlugin"
        ];
